...
describe(basename(__filename), () => {
  ...
  it('the github page should be opened when key and org was set', async () => {
    ...
    expect(openMock).toHaveBeenCalledWith(
      `${githubWebsite}org:skypesky+to-where-cli`
    );
  });
  ...
  it('the github page should be opened when keyword was set', async () => {
    ...
    expect(openMock).toHaveBeenCalledWith(`https://github.com/skypesky`);
  });
